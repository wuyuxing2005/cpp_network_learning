...
server: server.cpp Server.cpp epoll.cpp channel.cpp mysocket.cpp sock_addr.cpp EventLoop.cpp Acceptor.cpp Connection.cpp Buffer.cpp
	g++ server.cpp Server.cpp epoll.cpp channel.cpp mysocket.cpp sock_addr.cpp EventLoop.cpp Acceptor.cpp Connection.cpp  Buffer.cpp -o server

client: client.cpp epoll.cpp channel.cpp mysocket.cpp sock_addr.cpp EventLoop.cpp Acceptor.cpp Connection.cpp Buffer.cpp
	g++ client.cpp epoll.cpp channel.cpp mysocket.cpp sock_addr.cpp EventLoop.cpp Acceptor.cpp Connection.cpp  Buffer.cpp -o client
